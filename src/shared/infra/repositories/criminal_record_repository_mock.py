	...
	def __init__(self):
		...
		self.criminal_records = [
			CriminalRecord(
				...
				crimes=[CRIME_TYPE.BURGLARY, CRIME_TYPE.TERRORISM, CRIME_TYPE.HOMICIDE],
				is_arrested=False
			),
			CriminalRecord(
				criminal_record_id=2,
				criminal=self.criminals[8],
				crimes=[CRIME_TYPE.KIDNAPPING, CRIME_TYPE.THEFT, CRIME_TYPE.TERRORISM],
				is_arrested=False
			),
			CriminalRecord(
				criminal_record_id=3,
				criminal=self.criminals[7],
				crimes=[CRIME_TYPE.ROBBERY, CRIME_TYPE.ASSAULT, CRIME_TYPE.BATTERY],
				is_arrested=False
			),
		]
